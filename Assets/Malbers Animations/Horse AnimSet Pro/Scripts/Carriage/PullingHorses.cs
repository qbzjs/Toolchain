...
namespace MalbersAnimations.HAP
{
    public class PullingHorses : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            LHorseInitialPos = LeftHorse.transform.localPosition;          //Store the position of the Right Main Horse
            ...
            LeftHorse.RootMotion = false;
            RightHorse.RootMotion = false;
        ...
        IEnumerator Stabilizer()
        {
            ...
            while (Time.time - CurrentTime <= .5f)
            {
        ...
        void FixedUpdate()
        {
            ...
            if (LeftHorse && LeftHorse != RightHorse)                       //if is there a different left horse
            {
                ...
                LeftHorse.transform.localPosition = new Vector3(LHorseInitialPos.x, LeftHorse.transform.localPosition.y, LHorseInitialPos.z);
            }
