...
{
	public class UCCUMACreatorMenu : MonoBehaviour
	{
		...
		public void WardrobeClick()
		{
			...
			{
				if (((limitWardrobeOptions.Count == 0 || limitWardrobeOptions.Contains(s)) && !hideWardrobeOptions.Contains(s)))
				{
		...
		{
			// Note to future self! this will probably require an animator change,
			// assuming we are working with an UCCUMA
